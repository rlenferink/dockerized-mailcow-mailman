...
cp /etc/letsencrypt/live/mail.roylenferink.com/fullchain.pem ./data/assets/ssl/server4.roylenferink.com/cert.pem
cp /etc/letsencrypt/live/mail.roylenferink.com/privkey.pem ./data/assets/ssl/server4.roylenferink.com/key.pem
